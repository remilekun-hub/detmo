						...
						<div className="p-2 sm:w-1/2 w-full text-start  ">
							...
							<div className="flex flex-col gap-3 py-4">
								...
								<div className="bg-muted rounded flex  items-center">
									<LucidePlay className="size-4 mr-3 fill-foreground" />
									<span className="text-secondary-foreground">
										Analyze Spending by Suppliers, Months,
								...
								<div className="bg-muted rounded flex  items-center">
									<LucidePlay className="size-4 mr-3 fill-foreground" />
									<span className="text-secondary-foreground">
										Maximize Cost Savings and Optimize Budget
										Allocation.
									</span>
								</div>
							</div>
						...
						<div className="p-2 sm:w-1/2 w-full text-start  ">
							...
							<div className="flex flex-col gap-3 py-4">
								...
								<div className="bg-muted rounded flex  items-center">
									<LucidePlay className="size-4 mr-3 fill-foreground" />
									<span className="text-secondary-foreground">
										Simplify Sourcing with Part Numbers and
										Descriptions.
									</span>
								</div>
								<div className="bg-muted rounded flex  items-center">
									<LucidePlay className="size-4 mr-3 fill-foreground" />
									<span className="text-secondary-foreground">
										Ensure Optimal Supplier Selection Based on Cost,
				...
				<article className="flex flex-col md:flex-row justify-stretch items-start gap-20">
					...
					<div className=" text-start flex flex-col  gap-5">
						...
						<p className="text-lg text-wrap font-normal">
							At Detmo, we understand the complexities of procurement
							management and the impact it has on your organization&#39;s
							success. That&#39;s why we created our cutting-edge
							procurement software—to revolutionize the way you
							streamline your operations, drive cost efficiencies, and
							achieve procurement excellence.
						</p>
						<p className="text-lg text-wrap font-normal">
							Our software&#39;s powerful spend analysis capabilities and
							advanced sourcing projects feature are designed to empower
							you with actionable insights and enable seamless supplier
							selection. Join the ever-growing community of satisfied
							customers who have transformed their procurement processes
							with our software.
						</p>
